...
def update_z_data_missing(eta, z_data, A, alpha, w, k, b, t, z_range,lamda, m_p, z_data_mask):
    N,N,P = A.shape
    N,M = k.shape
    ...
    if b_comparing:
        ...
        z_data,cost_missing = compute_gradients_m( z_data, A, alpha, w, k, b, t, m_p, z_data_mask)
    
    z_data[:,t+1] = z_data - dC_dA
