...
cost_n = pickle.load(open("indi_results/cost_0.006_.txt","rb"))
cost_n_test = pickle.load(open("indi_results/cost_test_0.006_.txt","rb"))
cost_linear = pickle.load(open("indi_results/cost_linear_0.0008_.txt","rb"))
cost_linear_test = pickle.load(open("indi_results/cost_linear_test_0.0008_.txt","rb"))
A_n = pickle.load(open("indi_results/A_n_0.006_.txt","rb"))
A_l = pickle.load(open("indi_results/A_l_0.0007_.txt","rb"))
...
cb2 =  ax2.imshow(A_l[:,:,0], vmin=0, vmax=0.5, cmap='jet', aspect='auto')
cb2a =  ax2a.imshow(A_l[:,:,1], vmin=0, vmax=0.5, cmap='jet', aspect='auto')


cb3 =  ax3.imshow(A_n[:,:,0], vmin=0, vmax=0.5, cmap='jet', aspect='auto')
cb3a =  ax3a.imshow(A_n[:,:,1], vmin=0, vmax=0.5, cmap='jet', aspect='auto')
