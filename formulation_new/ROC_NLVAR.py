...
lam = pickle.load(open("lambda_sweep_f_n_0.05/lam_LVAR.txt","rb"))
...
GC_true = pickle.load(open("data/synthetic/A_true_P_2_T3000.pickle","rb"))
...
for i2 in range(len(lam)):
    ...
    GC_est =  pickle.load(open("lambda_sweep_f_n_0.05/A_n_"+str(np.round(lam[i2],4))+"_.txt","rb"))
