...
def multiprocess_train_lost_list(lamda):    
    ...
    dict = pickle.load(open("function_para/linear_para_dict_lundin.pickle","rb"))

    #pdb.set_trace()
    #z_data = z_data[:,0:100] #pickle.load(open("results/A_wAs.txt","rb"))
    ##########################################################################################

    cost,cost_test,A_n,cost_val = learn_model_balta(NE, etanl ,z_data,lamda,P, M,N_init,dict) 
